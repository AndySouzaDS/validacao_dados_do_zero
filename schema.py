...
class InventarioSchema(DataFrameModel):
    ...
    Esta classe define a estrutura de dados para produtos, incluindo informações sobre o nome do produto, a quantidade em estoque, o preço unitário, se o produto está 
    disponível para venda, e a data de validade do produto.
